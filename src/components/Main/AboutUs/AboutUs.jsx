...
const AboutUs = () => {
  return (
    <section id='aboutUs'>
        <h2>Nosotros</h2>
            <p>
              <span className='block'>Somos una agencia especializada en la venta de vehiculos de alta gama.</span>
              ...
              <span className='block'>Para ello, contamos con diversos modelos, marcas y precios.</span>

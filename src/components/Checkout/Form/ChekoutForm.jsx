...
const ChekoutForm = ({cartItems, price, prePurchase}) => {
        ...
        >
            {
                ({isSubmitting}) => (
                    <Form className='checkoutForm'>
                        <input htmlFor='email' type='email' id='email' name='email' placeholder='spaceshipagency@gmail.com'>Tu email</input>
                        <input htmlFor='cellphone' type="number" id='cellphone' name='cellphone' placeholder='1136364747'>Tu telefono</input>
                        <input htmlFor='address' type="text" id='address' name='address' placeholder='Avenida Libertador 2799'>Tu direccion</input>
                        <input htmlFor='cardNumber' type='number' id='cardNumber' name='cardNumber' placeholder='4646575768687979'>Tu numero de tarjeta</input>
                        <div>
